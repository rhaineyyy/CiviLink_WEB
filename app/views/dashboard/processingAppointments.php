...
<head>
    ...
    <title>Processing Appointments - Government Portal</title>
...
<div class="w-64 bg-gray-800 text-white p-6 flex flex-col shadow-xl">
    ...
    <nav class="space-y-2 flex-grow">
        ...
        <a href="/admin/processingAppointments" class="flex items-center px-4 py-2 rounded-lg transition duration-150 ease-in-out font-medium bg-blue-600 hover:bg-blue-700 shadow-md">
            <i class="fas fa-sync-alt w-5 mr-3"></i>
            Processing Appointments
        </a>
        <a href="/admin/recentRecords" class="flex items-center px-4 py-2 rounded-lg transition duration-150 ease-in-out font-medium hover:bg-gray-700">
...
<div class="flex-1 p-4 md:p-8 lg:p-12">
    <header class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Processing Appointments</h1>
        <p class="text-gray-500 mt-1">View and manage appointments currently being processed</p>
    </header>
    ...
    <!-- Processing Appointments Section -->
