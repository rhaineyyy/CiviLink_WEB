...
<head>
    ...
    <title>Pending Appointments - Government Portal</title>
...
<div class="w-64 bg-gray-800 text-white p-6 flex flex-col shadow-xl">
    ...
    <nav class="space-y-2 flex-grow">
        ...
        <a href="/admin/pendingAppointments" class="flex items-center px-4 py-2 rounded-lg transition duration-150 ease-in-out font-medium bg-blue-600 hover:bg-blue-700 shadow-md">
...
<div class="flex-1 p-4 md:p-8 lg:p-12">
    <header class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Pending Appointments</h1>
        <p class="text-gray-500 mt-1">Review and manage appointments awaiting approval</p>
    </header>
